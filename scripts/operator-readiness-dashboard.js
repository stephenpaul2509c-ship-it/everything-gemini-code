...
function buildRequirements(rootDir, platformReport) {
  ...
  return [
    ...
    buildRequirement(
      ...
      'Advance EGC Tools native payments and AI-native harness-agnostic app',
      'EGC Tools PR evidence, billing gate, hosted analysis lanes',
...
function renderText(report) {
  const lines = [
    `EGC Operator Readiness Dashboard: ${report.ready ? 'objective ready' : 'work remaining'}`,
...
function renderMarkdown(report) {
  const lines = [
    '# EGC Operator Readiness Dashboard',
    '',
    ...
    '',
    'Growth lanes: GitHub Sponsors and OSS partner sponsors; EGC Tools Pro subscriptions; consulting and implementation contracts; talks, podcasts, conference demos, and partner webinars.',
    '',
