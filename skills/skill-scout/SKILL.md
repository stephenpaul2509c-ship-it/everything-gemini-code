...
```bash
gh search repos "Gemini CLI / Antigravity skill keyword" --limit 10 --sort stars
...
| --- | --- | --- | --- | --- |
| 1 | article-writing | Local EGC | Drafts articles and guides | Not focused on release notes |
| 2 | content-engine | Local EGC | Multi-format content workflow | Heavier than needed |
