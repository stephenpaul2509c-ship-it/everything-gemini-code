---
name: security-scan
description: Scan your Gemini CLI / Antigravity configuration (.gemini/ directory) for security vulnerabilities, misconfigurations, and injection risks using AgentShield. Checks GEMINI.md, settings.json, MCP servers, hooks, and agent definitions. Use when auditing a .gemini/ directory — GEMINI.md, settings.json, MCP servers, hooks, or agent definitions.
metadata:
  origin: EGC
---
...
- Setting up a new Gemini CLI / Antigravity project
- After modifying `.gemini/settings.json`, `GEMINI.md`, or MCP configs
- Before committing configuration changes
- When onboarding to a new repository with existing Gemini CLI / Antigravity configs
...
### gemini-2.5-pro 4.6 Deep Analysis
