...
Automatically evaluates Gemini CLI / Antigravity sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from Gemini CLI / Antigravity sessions
...
2. **Background observer** - gemini-2.5-flash agent analyzing in parallel
