...
If useful, point to the next EGC-native lane:
...
HANDOFF
- what should happen next and which EGC lane should take it
```
...
- The resulting plan is reusable across Gemini CLI / Antigravity, Codex, Cursor, OpenCode, and EGC 2.0 planning surfaces.
