...
1. **Run the package-manager detector** (ships with EGC):
...
.gemini/tdd/<plan-or-task-name>.tdd.md
```

If the repository already uses Gemini-specific local artifacts, the `.gemini/tdd/` location is also acceptable. Include:
