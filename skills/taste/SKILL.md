...
## The Pipeline — mixing the EGC video skills

This skill is the conductor. Each EGC skill is an instrument. Do not skip layers.
...
| Step | EGC skill to load | What it does here |
|------|-------------------|-------------------|
