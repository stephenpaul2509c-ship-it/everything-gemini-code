...
**Model:** gemini-2.5-pro by default; raise via `GAN_PLANNER_MODEL=gemini-2.5-pro` for deeper spec expansion
...
**Model:** gemini-2.5-pro by default; raise via `GAN_GENERATOR_MODEL=gemini-2.5-pro` for maximum coding capability
...
**Model:** gemini-2.5-pro by default; raise via `GAN_EVALUATOR_MODEL=gemini-2.5-pro` for stronger judgment + tool use
...
### Via Gemini CLI / Antigravity (Manual)
...
### Stage 2 — Capable Models (gemini-2.5-pro 4.5-class)
...
### Stage 3 — Frontier Models (gemini-2.5-pro 4.6-class)
