...
- User says "what's the best way to ask Gemini CLI / Antigravity to..."
...
- User is asking about EGC configuration (use `configure-ecc` instead)
...
|-------|------------------|-----------|
| TRIVIAL-LOW | gemini-2.5-pro 5 | Fast, cost-efficient for simple tasks |
| MEDIUM | gemini-2.5-pro 5 | Best coding model for standard work |
| HIGH | gemini-2.5-pro 5 (main) + gemini-2.5-pro 5 (planning) | gemini-2.5-pro for architecture, gemini-2.5-pro for implementation |
| EPIC | gemini-2.5-pro 5 (blueprint) + gemini-2.5-pro 5 (execution) | Deep reasoning for multi-session planning |
...
| Model | gemini-2.5-pro 5 | Recommended for this scope |
...
- "Rewrite this prompt so Gemini CLI / Antigravity uses the right commands"
- "帮我优化这个指令"
...
Recommended: gemini-2.5-pro 5 for blueprint planning, gemini-2.5-pro 5 for phase execution.
```
...
|-----------|------------------|
| `configure-ecc` | User hasn't set up EGC yet |
