---
name: eval-harness
description: Formal evaluation framework for Gemini CLI / Antigravity sessions implementing eval-driven development (EDD) principles. Use when a Gemini CLI / Antigravity workflow needs a formal eval before it is trusted or changed.
metadata:
  origin: EGC
...
A formal evaluation framework for Gemini CLI / Antigravity sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for Gemini CLI / Antigravity task completion
