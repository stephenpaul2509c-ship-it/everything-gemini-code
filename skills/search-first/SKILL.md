...
| Skills directory | `ls ~/.gemini/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, Gemini CLI / Antigravity skills, GitHub
  Return: Structured comparison with recommendation
")
```

Older Gemini CLI / Antigravity docs may call this `Task(...)`; use the current agent/subagent
