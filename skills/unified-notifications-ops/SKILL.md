...
- the user wants to consolidate overlapping notification branches or backlog proposals into one EGC-native lane
...
Prefer EGC-native orchestration over telling the user to adopt a separate notification product.
...
Call out what EGC already owns.
...
### 4. Design the EGC-native workflow
...
If EGC already has the primitive, prefer:
...
- "Collapse overlapping notification PR ideas into one canonical EGC lane"
