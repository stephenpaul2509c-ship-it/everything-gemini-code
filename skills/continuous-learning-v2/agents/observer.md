...
A background agent that analyzes observations from Gemini CLI / Antigravity sessions to detect patterns and create instincts.
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/egc-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/egc-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/egc-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/egc-homunculus/instincts/personal/` (for universal patterns)
