---
name: unified-memory
description: Share durable, inspectable context and handoffs between Gemini, Codex, Hermes, Cursor, OpenCode, and other agents through the local EGC Memory Vault. Use when an agent must save work state, transfer context, resume another agent's task, or search shared project knowledge.
metadata:
  origin: EGC
---
...
Use the EGC Memory Vault as the common context layer between harnesses. The
...
- Hand work from Gemini to Codex, Hermes to Gemini, or any other harness pair.
