...
```json
{
  "hooks": {
    "PreToolUse": [
      {
        "matcher": "Edit",
        "hooks": [{ "type": "command", "command": "node ~/.gemini/scripts/hooks/suggest-compact.js" }]
      },
      {
        "matcher": "Write",
        "hooks": [{ "type": "command", "command": "node ~/.gemini/scripts/hooks/suggest-compact.js" }]
...
- [The Longform Guide](https://github.com/stephenpaul2509c-ship-it/everything-gemini-code) — Token optimization section
