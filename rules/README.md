...
>
> Use the EGC-owned namespace below for user-level Gemini installs. Flat
> package-level destinations can collide with non-EGC rule packs and do not
> match the main README guidance.

```bash
# Create the EGC rule namespace once.
...
cp -r rules/angular ~/.gemini/rules/ecc/
cp -r rules/vue ~/.gemini/rules/ecc/
cp -r rules/nuxt ~/.gemini/rules/ecc/
cp -r rules/python ~/.gemini/rules/ecc/
cp -r rules/golang ~/.gemini/rules/ecc/
cp -r rules/web ~/.gemini/rules/ecc/
cp -r rules/react-native ~/.gemini/rules/ecc/
cp -r rules/swift ~/.gemini/rules/ecc/
cp -r rules/php ~/.gemini/rules/ecc/
cp -r rules/ruby ~/.gemini/rules/ecc/
cp -r rules/arkts ~/.gemini/rules/ecc/
