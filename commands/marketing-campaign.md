...
When saving campaign assets, the convention is `.gemini/campaigns/{campaign-name}/`:

```
.gemini/campaigns/product-launch/
├── positioning.md
├── landing-page.md
├── email-sequence.md
├── social-posts.md
...
```
/marketing-campaign review .gemini/campaigns/the-key/landing-page.md
```
