...
|-------|-------|--------|
| Implementation | `~/.gemini/.ccg/prompts/codex/architect.md` | `~/.gemini/.ccg/prompts/antigravity/frontend.md` |
...
**If ace-tool MCP is NOT available**, use Gemini CLI / Antigravity built-in tools as fallback:
...
1. Call Antigravity (use `~/.gemini/.ccg/prompts/antigravity/frontend.md`)
