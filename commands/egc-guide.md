...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside EGC
...
- `/project-init` for stack-aware EGC onboarding of a target project
...
- `/security-scan` for Gemini/OpenCode configuration security review
