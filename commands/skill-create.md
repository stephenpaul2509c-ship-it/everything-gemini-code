...
3. **Generates SKILL.md** - Creates valid Gemini CLI / Antigravity skill files
...
`.gemini/skills/`; a global skill uses `~/.gemini/skills/`.
...
The directory form is required for discovery: Gemini CLI / Antigravity treats
