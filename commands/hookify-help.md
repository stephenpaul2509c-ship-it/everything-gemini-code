...
Hookify creates rule files that integrate with Gemini CLI / Antigravity's hook system to prevent unwanted behaviors.

### Event Types

- `bash`: triggers on run_command tool use and matches command patterns
- `file`: triggers on Write/replace_file_content tool use and matches file paths
