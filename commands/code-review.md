...
2. **Planning artifacts** — Check `.gemini/prds/`, `.gemini/plans/`, `.gemini/reviews/`, and legacy `.gemini/PRPs/{prds,plans,reports,reviews}/` for context related to this PR
...
Create review artifact at `.gemini/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.gemini/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .gemini/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
