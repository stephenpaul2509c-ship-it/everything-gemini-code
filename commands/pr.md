...
- `.gemini/prds/` — PRDs this PR implements a milestone of
- `.gemini/plans/` — Plans executed by this PR
- `.gemini/PRPs/prds/` — legacy PRP PRDs
- `.gemini/PRPs/plans/` — legacy PRP implementation plans
- `.gemini/PRPs/reports/` — legacy PRP implementation reports
